...
public class TowerActionsBuild : TowerAction
{
    ...
    private GameManage levelManager;
    ...
    void Awake()
    {
        ...
        levelManager = FindObjectOfType<GameManage>();
        ...
        if (levelManager.towerList.Contains(towerPrefab) == true)
        {
