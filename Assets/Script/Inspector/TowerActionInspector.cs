...
/// </summary>
public class TowerActionInspector : MonoBehaviour
{
    ...
    {
        return InspectorUtil<TowerAction>.GetNext(transform, currentSelected);
    }

    public GameObject GetPrevioustAction(GameObject currentSelected)
    {
        return InspectorUtil<TowerAction>.GetPrevious(transform, currentSelected);
    }
}
#endif
