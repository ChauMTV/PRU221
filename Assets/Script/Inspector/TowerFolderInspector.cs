...
/// </summary>
public class TowerFoldersInspector : MonoBehaviour
{
    ...
    {
        return InspectorUtil<BuildingPlace>.GetNext(towerFolder, currentSelected);
    }
    ...
    {
        return InspectorUtil<BuildingPlace>.GetPrevious(towerFolder, currentSelected);
    }
}
#endif