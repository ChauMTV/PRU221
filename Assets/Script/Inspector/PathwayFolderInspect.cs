...
public class PathwayFolderInspect : MonoBehaviour
{
    ...
    {
        return InspectorUtil<Pathway>.GetNext(pathwayFolder, currentSelected);
    }
    ...
    {
        return InspectorUtil<Pathway>.GetPrevious(pathwayFolder, currentSelected);
    }
    ...
    {
        Endpoint[] array = GetComponentsInChildren<Endpoint>();
    ...
    {
        return InspectorUtil<Endpoint>.GetNext(capturePointFolder, currentSelected);
    }
    ...
    {
        return InspectorUtil<Endpoint>.GetPrevious(capturePointFolder, currentSelected);
    }
}
#endif
